...
class MaintenanceRecord(models.Model):
    # Bandera transitoria (no persiste): la marca create_record_for_standalone_work_order
    # al crear el registro desde una OT independiente, para que sync_work_order_from_record
    # no genere otra OT de vuelta. Ver apps/maintenance/signals.py.
    _from_standalone_work_order: bool = False
